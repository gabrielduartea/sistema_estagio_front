exports.ids = [10];
exports.modules = Array(144).concat([
/* 144 */
...
/* harmony import */ var _VCard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(150);
...
"use strict";
/* harmony import */ var _src_components_VCard_VCard_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(175);
/* harmony import */ var _src_components_VCard_VCard_sass__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_components_VCard_VCard_sass__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _VSheet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54);
/* harmony import */ var _mixins_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(145);
...
var returnable = __webpack_require__(157);
...
var VInput = __webpack_require__(153);
...
"use strict";
/* harmony import */ var _VDivider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(161);
...
var loadable = __webpack_require__(145);
...
"use strict";
/* harmony import */ var _src_components_VDataTable_VSimpleTable_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177);
...
/* harmony import */ var _src_components_VGrid_VGrid_sass__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(66);
...
/* harmony import */ var _mixins_overlayable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(56);
/* harmony import */ var _mixins_returnable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(157);
/* harmony import */ var _mixins_stackable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(158);
/* harmony import */ var _directives_click_outside__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(49);
...
var VDataTable = __webpack_require__(185);
...
var VDataFooter = __webpack_require__(187);
...
var VAutocomplete = __webpack_require__(216);
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/internships/_id/index.vue?vue&type=template&id=36d44d8e&
...
var _idvue_type_template_id_36d44d8e_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VContainer["a" /* default */], [_c(VRow["a" /* default */], [_c(VCol["a" /* default */], [_c('NuxtLink', {
    ...
    attrs: {
      "dark": "",
      "small": "",
      "color": _vm.getColorStatus(_vm.item.status)
    }
  }, [_vm._v("\n            " + _vm._s(_vm.item.status) + "\n          ")]), _vm._v(" "), _c(VChip["a" /* default */], {
    attrs: {
      "dark": "",
      "small": "",
      "color": _vm.getColorActivitiesPlan(_vm.item.planoAtividades)
    }
  }, [_vm._v("\n            " + _vm._s(_vm.item.planoAtividades) + "\n          ")]), _vm._v(" "), _c(VChip["a" /* default */], {
    attrs: {
      "dark": "",
      "small": "",
      "color": _vm.getColorrelatorio(_vm.item.relatorio)
    }
  }, [_vm._v("\n            " + _vm._s(_vm.item.relatorio) + "\n          ")])], 1)], 1)], 1)], 1);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/internships/_id/index.vue?vue&type=template&id=36d44d8e&

// EXTERNAL MODULE: external "axios"
var external_axios_ = __webpack_require__(24);

// EXTERNAL MODULE: external "moment"
var external_moment_ = __webpack_require__(135);
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  methods: {
    async getStudents() {
      debugger;
      const students = await api["a" /* default */].get(`estudantes/findAll`);
    ...
    async getInternships() {
      const internshipDetails = await api["a" /* default */].get(`estagios/${this.$route.params.id}`);
    ...
    async showPeriods() {
      const periods = await api["a" /* default */].get(`estagios/${this.id}`);
    ...
    async store() {
      try {
        const student = await api["a" /* default */].post(`estagios/create`, {
    ...
    async update(id) {
      try {
        const student = await api["a" /* default */].put(`estagios/${id}`, {
          internship_id: this.$route.params.id,
    ...
    async destroy(id) {
      await api["a" /* default */].delete(`periods/${id}`);
      this.initialize();
    },
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  _idvue_type_template_id_36d44d8e_render,
  staticRenderFns,
  false,
  null,
  null,
